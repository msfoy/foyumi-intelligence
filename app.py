...
# Book Your Glam uses one fixed, tight-cropped image so the composition
# remains consistent on Streamlit Cloud.
def find_booking_image():
    if not IMAGE_DIR.exists():
        return None

    preferred = IMAGE_DIR / "IMG_2151_BOOKING_TIGHT.webp"
    if preferred.exists():
        return preferred

    # Safe fallback to the existing deployed image if the tight crop
    # has not yet been uploaded to GitHub.
    fallback_names = [
        "IMG_2151.JPG.webp",
        "IMG_2151.JPG.jpeg",
        "IMG_2151.jpg.webp",
...
st.markdown(
    ...
    div[data-testid="stMetric"] {{
        ...
        /* ========================================================
           FINAL READABILITY + BOOK YOUR GLAM CONTROL OVERRIDE
           Force a light UI and strong text rendering on mobile.
           ======================================================== */
        :root, html, body, .stApp {{
            color-scheme: light !important;
        }}

        /* Do not allow Streamlit/mobile theme opacity to fade copy. */
        [data-testid="stAppViewContainer"] *,
        ...
        /* Strong readable text throughout the actual app content. */
        [data-testid="stAppViewContainer"] p,
        [data-testid="stAppViewContainer"] span,
        [data-testid="stAppViewContainer"] label,
        [data-testid="stAppViewContainer"] li,
        ...
        /* Keep headings / branded titles brown. */
        [data-testid="stAppViewContainer"] h1,
        [data-testid="stAppViewContainer"] h2,
        [data-testid="stAppViewContainer"] h3,
        [data-testid="stAppViewContainer"] h4,
        ...
        [data-testid="stAppViewContainer"] .action-title,
        [data-testid="stAppViewContainer"] .metric-value {{
            color: #6F4E45 !important;
            -webkit-text-fill-color: #6F4E45 !important;
            opacity: 1 !important;
        }}

        /* --------------------------------------------------------
           BOOK YOUR GLAM — all fields use a light FOYUMI brown box
           with dark, fully visible entered/selected text.
           -------------------------------------------------------- */
        div[data-testid="stForm"] {{
            background: #FFFFFF !important;
        }}
        ...
        div[data-testid="stForm"] [data-baseweb="textarea"] {{
            ...
            -webkit-text-fill-color: #332723 !important;
            opacity: 1 !important;
            border-color: #C9A89A !important;
        }}

        /* Text inside BaseWeb select/input containers. */
        ...
        div[data-testid="stForm"] textarea::placeholder {{
            ...
            -webkit-text-fill-color: #6A5750 !important;
            opacity: 1 !important;
        }}

        /* Select arrow + date/calendar controls must remain visible. */
        ...
        div[data-testid="stForm"] button svg {{
            fill: #6F4E45 !important;
            color: #6F4E45 !important;
            stroke: #6F4E45 !important;
            opacity: 1 !important;
        }}

        /* Preferred date gets the same light-brown treatment. */
        div[data-testid="stForm"] [data-testid="stDateInput"] input,
        div[data-testid="stForm"] [data-testid="stDateInput"] [data-baseweb="input"],
        div[data-testid="stForm"] [data-testid="stDateInput"] [data-baseweb="input"] > div,
        div[data-testid="stForm"] [data-testid="stDateInput"] button {{
            background: #EAD8CF !important;
            color: #332723 !important;
            -webkit-text-fill-color: #332723 !important;
            opacity: 1 !important;
        ...
        /* Booking submit button: same light brown box, dark readable text. */
        ...
        div[data-testid="stForm"] [data-testid="stFormSubmitButton"] button * {{
            ...
            -webkit-text-fill-color: #332723 !important;
            opacity: 1 !important;
            border: 1px solid #C29A8A !important;
        ...
        /* Radio choices in Book Your Glam remain readable. */
        ...
        /* Dropdown/date-picker popovers are rendered outside the form.
           Keep them light and readable too. */
        [role="listbox"],
        [role="option"],
        ...
        /* --------------------------------------------------------
           Mobile browser controls / sidebar trigger.
           -------------------------------------------------------- */
        @media (max-width: 768px) {{
            header,
            header *,
